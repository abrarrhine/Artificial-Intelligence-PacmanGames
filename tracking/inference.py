...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for positions in pos:
            selfB[positions] = self.getObservationProb(observation, pacmanPos, positions, jailPos) * self.beliefs[positions]
        self.beliefs = selfB
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for particleX, particleY in eParticles:
                newParticle[particleX] = self.getPositionDistribution(gameState, oldParticle, particleX, self.ghostAgents[particleX]).sample()
